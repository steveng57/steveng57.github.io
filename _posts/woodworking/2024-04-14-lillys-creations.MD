...
tags: [Woodworking, Walnut, Pencil Holder, Trays, Shaper Origin, Epoxy, Inlay]
image:
  path: IMG_0912.avif
  thumb: /thumbnails/IMG_0912.avif
...
{% include figure.html img="IMG_0868.avif" align="left" %}
...
{% include figure.html img="IMG_0870.avif" align="right" %}
...
{% include figure.html img="IMG_0871.avif" align="left" %}

### The Carve

The carve was done with the {{ site.data.links.origin }}, and it turned out pretty well.

The only complication was that I had to make sure I didn't damage the fine point on the mitred edges when locking the board down for the cut.
...
{% include figure.html img="IMG_0901.avif" align="right" %}

### Glue-up Prep

The dry fit before the glue-up is shown here. I think I must have dry-fitted this one about a dozen times before committing to it.
...
{% include figure.html img="IMG_0882.avif" align="left" %}

### The Glue-up

Band clamps are great for mitred boxes, as they put inward force on the corner joints toward the centre of the box.

{% include clear-float.html %}

{% include figure.html img="IMG_0912.avif" align="right" %}

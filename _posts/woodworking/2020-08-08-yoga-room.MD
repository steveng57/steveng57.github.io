...
image:
  path: IMG_0530.avif
  thumb: /thumbnails/IMG_0530.avif
  alt: Zen Table for Yoga Room
media_subpath: /assets/img/posts/yoga-room
---
## Origins

I've made a few things for the customer Debbie's yoga room. In 2020, I made an oval (ellipsoid?) table to go inside a curved wall and a dolly/stand for her heater on casters.

## Danger Danger

I am including a close-up pic of the handle here because this was one of my first truly scary experiences in the shop. I was using the router table to put a round-over on the inside and outside of the handle curves so that it was more comfortable to use when the router bit grabbed hold of the piece, shattered it, and violently threw the many bits in all directions.
...
{% include figure.html img="20200808_184843.avif" align = "left" %}
...
{% include figure.html img="20200808_184834.avif" align = "right" %}

### Healing

I found all the bits from the router table explosion, glued them all back together, and sanded everything smooth again.
...
{% include figure.html img="20200714_172147328_iOS.avif" align = "left" %}

### Curves

The table for the yoga room was very fun to make. It is a big chunk of maple on which I used a router template to cut the radius.
...
{% include figure.html img="IMG_0531.avif" align = "center" %}
{% include clear-float.html %}

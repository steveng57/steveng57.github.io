...
image:
  path: IMG_0758C.avif
  thumb: /thumbnails/IMG_0758C.avif
...
{% include figure.html img="gazebo-cabinet-sketchup.avif" align="left" %}
...
{% include figure-pair.html img1="IMG_0760.avif" img2="IMG_0758C.avif" %}

We built this to fit under the TV in the gazebo. The gazebo is the name for a small building we have in the back that is set up as a little getaway room. It's a pretty cool little spot.
...
{% include figure.html img="IMG_0759.avif" align="center" %}

...
description: A birthday gift for Dad.  Cribbage has been a lifetime passion.
...
image:
  path: IMG_0626.avif
  thumb: /thumbnails/IMG_0626.avif
...
Almost half the work on this one was at the computer making sure the design was right. I didn't do the entire layout; I spent about $20 for a design from Etsy, then made a bunch of modifications using the online tools from {{ site.data.links.shaperhub }}.

## Under Construction

Lots of pictures on this one. **Hey, it was a lot of work.**

{% include figure.html img="CribbageBoard02.avif" align="left" %}
...
{% include figure.html img="20230720_163338.avif" align="right" %}

### Finish

Finishing this one was a little tricky too. I use a hard-wax oil called {{ site.data.links.rubio }} for most of my projects these days. It makes for a great, durable, and repairable finish. It is also way less finicky than other finishes: you apply it, wait a bit, and wipe off the excess. Nothing really sticks to it, so shop dust is not so much of a problem.
...
{% include figure.html img="20230720_163408.avif" %}
...
{% include figure.html img="IMG_0626.avif" align="center-wide" %}

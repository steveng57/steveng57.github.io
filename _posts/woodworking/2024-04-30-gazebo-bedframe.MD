...
image:
  path: gazebo-bedframe-sketchup.avif
  thumb: /thumbnails/gazebo-bedframe-sketchup.avif
  alt: Gazebo Bedframe
...
So we did it up a little nicer than your typical storage shed, putting in some nice flooring, drywall, etc. A TV and a bed were also added, but the bed was a bit too big, so I made this custom bedframe. It's a low-riding frame to keep the size down, made with white oak sides, fir slats, and a plywood pedestal.

It was a pretty simple, standard project, and we can't have that, so I added some LED lighting to the outside rim of the frame to give it some pizzazz. Details below.

## The Bedframe

### The Design

Per my usual process, I drew this up in {{ site.data.links.sketchup}}, as shown in the pic above, which helps you visualize everything up front, the theory being that it will minimize mistakes later.  This is often true, but not always.

{% include clear-float.html %}

{% include figure.html img="IMG_0947.avif" align="left" %}

### The Pedestal

The pedestal for the bed is a bunch of plywood strips, each cut about 10 cm (4 in) wide.  It was doubled up to make it about 36 mm (1.5 in) high, and given that we wanted to keep this frame low to the ground, that worked out great.

{% include clear-float.html %}

{% include figure.html img="IMG_0948.avif" align="right" %}

### Pedestal Glue-up

This pic might make it look like I am gluing the plywood together here, but I am actually gluing on white-oak edge banding to hide the visible plywood layers on the side of the pedestal.  Now, it's a pretty low-slung bed, so one isn't likely to see the pedestal from the sides, but still, I want it to look nice when someone does see the underside.

I made the edge banding myself from offcuts of the sides of the bedframe itself.  I cut them roughly on the table saw and then slimmed them down with the drum sander.

{% include clear-float.html %}

{% include figure.html img="IMG_0959.avif" align="left" %}

### Assembly Time

I brought everything out to the gazebo and assembled things there.  

It's all upside down in this pic: the bedframe sides are on the bottom, then the slats are screwed into a rabbet cut along the bottom of the sides.  The pedestal was then screwed into that.

Not that we plan on moving this that often, but it can be disassembled into smaller, packable parts if needed.

{% include clear-float.html %}

{% include figure.html img="IMG_0962.avif" align="right" %}
...
{% include figure.html img="IMG_1092.avif" align="left" %}

### Lights, Camera, Action

Get your minds out of the gutter, people!

I added an LED lighting strip to the bottom, pointing downward to light up the floor around the bed.  Since this was a pretty plain piece, it needed something to jazz it up a bit.
...
- {{ site.data.links.kreg}} pocket screws for slat joinery

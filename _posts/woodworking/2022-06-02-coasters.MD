...
image:
  path: IMG_0706.avif
  thumb: /thumbnails/IMG_0706.avif
  alt: Coasting along
...
These coasters were probably the second project I made with the {{ site.data.links.origin }} and epoxy inlay. They turned out okay, but that's only because I threw the first four of them out. The epoxy would bleed into the surrounding wood, and when attempting to sand that out, I sanded too deep and the image was lost. I learned two things:
...
{% include figure.html img="IMG_0703.avif" align="left" %}

### Happy Puppy

This little guy is my favorite. She has the same spirit and joy as our boys.

I found the design somewhere on the internet, modified it in Inkscape, and then loaded it onto the {{ site.data.links.origin }}.
{% include clear-float.html %}

{% include figure.html img="IMG_0708.avif" align="right" %}
...
{% include figure.html img="IMG_0701.avif" align="center-wide" %}
{% include clear-float.html %}

...
image:
  path: IMG_0639.avif
  thumb: /thumbnails/IMG_0639.avif
  alt: It's a keeper
...
{% include figure.html img="IMG_0637.avif" align="left" %}
...
{% include figure.html img="IMG_0640.avif" align="right" %}
...
I am not sure I am making myself clear here, nor do I think I can in this post. But if you really want some of the finer details on this stuff, check out the YouTube video from [The Wood Whisperer](https://www.youtube.com/@woodwhisperer) on the [Four Corner Grain Match](https://youtu.be/SUd3I6Kx1Z0?si=ZVx0jnFtcppiO9HG). Marc is one of my YouTube woodworking heroes; he always produces good, helpful stuff in a fun and entertaining way.

Orange {{ site.data.links.chillepoxy }} was used for the inlay, which was carved with the {{ site.data.links.shaper }}.

## All done

{% include figure.html img="IMG_0639.avif"%}

...
image:
  path: IMG_0693.avif
  thumb: /thumbnails/IMG_0693.avif
...
{% include figure.html img="sketchup-table.avif" %}

Of course there is the {{ site.data.links.sketchup }}  design.  A lot of detail went into the actual pieces, since the cuts are kind of intricate.  Walnut is pricey, so you don't want to leave too much to chance.

I even went so far on this one as to find a _walnut texture_ and add it to the drawing.  It's a little scary how similar the real thing turned out to this.

{% include clear-float.html %}

## The Table

{% include figure.html img="IMG_0490.avif" align="left" %}
...
{% include figure.html img="IMG_0499.avif" align="right" %}
...
{% include figure.html img="IMG_0512.avif" align="left" %}

### The Glue-up

The tabletop is shown here, glued together and finished with {{ site.data.links.rubio }} walnut oil 2C. Great stuff.
{% include clear-float.html %}

{% include figure.html img="IMG_0516.avif" align="right" %}
...
The metal brackets in the corners were probably overkill, as the {{ site.data.links.domino }} XL was used to put in some big 80mm tenons. There are four tenons in each corner, which should give it more than enough strength. BooYah!
{% include clear-float.html break=0 %}

## The Benches

{% include figure.html img="IMG_0634.avif" align="left" %}

### Bench Legs

The bench legs followed the same general design pattern as the table legs, just scaled down to 2/3 the size of the table. This scaling was a general rule for the benches, which I intentionally broke in a few places, like in the support stretchers for the bench-tops, which I made as thick as I reasonably could to make sure they were strong enough.

{% include clear-float.html %}

{% include figure.html img="IMG_0656.avif" align="right" %}
...
{% include figure.html img="IMG_0659.avif" align="left" %}

### Bench Legs Fin

These are the bench legs. The inside stretchers in the middle are really just for aligning the outside stretchers, keeping them parallel.

{% include clear-float.html break=0 %}

## Putting It All Together

So you put the tops on the legs of the table and both benches, assembled with some funky z-clips to avoid any expansion and contraction issues, and then you bring it all together and you have this.

Here is a mini photo gallery of the table and benches set up in our theatre room. Click on a pic to zoom in for details if you are so inclined.

{% include figure-pair.html img2="IMG_0693.avif" img1="IMG_0691.avif" %}
...
{% include embed/video-hls.html
  id="img-0695-abr"
  master="stream/IMG_0695/master.m3u8"
  poster="stream/IMG_0695/poster.avif"
  title="Walnut Table"
  caption="Walnut Table - 180° View"
  controls="true"
  muted="false"
  autoplay="false"
  loop="false"

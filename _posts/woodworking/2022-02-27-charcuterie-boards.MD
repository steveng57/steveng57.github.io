...
description: Serving trays made from walnut, maple, and a number of exotic African woods.
date: 2022-02-25 18:32:00 -0500
last_modified_at: 2024-02-17 18:32:00 -0500
category: [Woodworking, Kitchen]
tags: [Woodworking, Charcuterie Board, Kitchen, Maple, Walnut]
image:
  path: 20220227_191616.avif
  thumb: /thumbnails/20220227_191616.avif
  alt: One for Theresa
media_subpath: /assets/img/posts/charcuterie-boards
series: "Kitchen Serving"
---
## Origins

Okay, so the difference between a charcuterie board and a cutting board is that a charcuterie board is meant for serving things, not cutting things. Now that we have that out of the way... these are super fun to make. Not too hard to make, but they do require **a lot** of sanding.

## Under Construction

{% include figure.html img="20220227_191600.avif" align="left" %}

### In the Sticks

Take a bunch of sticks, glue them together in just the right order, then run them through the planer to get a start on the smoothing process, and then start sanding at 80 grit. I wanted a smooth, glossy look, so I sanded all the way to 600 grit.
...
It was finished with a food-safe product called Honeybees Natural Wood Cream, which is mostly beeswax. Doesn't that sound just yummy? The rubber feet and stainless-steel connecting screws were procured from local artisans (Lee Valley and Home Depot, respectively).

## In Production

{% include figure.html img="IMG_0547.avif" %}
...
- **Mahogany:** From Africa, the color is variable, ranging from a very pale pink to a deeper reddish brown, sometimes with streaks of medium to dark reddish brown. Color tends to darken with age. Quartersawn surfaces can also exhibit a ribbon-stripe appearance. It comprises a handful of species from the Khaya genus, all of which are native to Africa. It sometimes lacks the deeper reddish brown color and durability that are common in true mahogany.

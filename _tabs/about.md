...
layout: page
title: About
description: About Steve Goulet, the author of this site, and a guide to navigating it.
author: sjg
...
The [Image Gallery]({% link _tabs/gallery.md %}) is an alphabetical listing of the best images from all the posts on the site, the top three or four per post. This is meant to be a purely visual experience, and it's a fun way to go through things. Use the filter buttons at the top of the gallery to narrow the view to a specific category.
...
To all the fans of this website, pictured below, please [let me know]({% link contact/index.html %}) if you find any bugs or other inaccuracies. This is very much a work in progress.
